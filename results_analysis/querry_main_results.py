...
def data_fetcher():
    ...
    df.to_csv("./results_analysis/data/main_results_summary.csv",
              index=False)

    run_results.to_csv("./results_analysis/data/main_results_full.csv",
                       index=False)
    print("Results saved to main_results_full.csv")
